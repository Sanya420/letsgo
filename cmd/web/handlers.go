...
func (app *application) signupUser(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		app.render(w, r, "signup_page.html", &templateData{Form: form})
		return
	}
...
func (app *application) loginUserForm(w http.ResponseWriter, r *http.Request) {
	app.render(w, r, "login_page.html", &templateData{Form: forms.New(nil)})
}
...
func (app *application) loginUser(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			...
			app.render(w, r, "login_page.html", &templateData{Form: form})
		} else {
			app.serverError(w, err)
		}
		return
	...
	http.Redirect(w, r, "/sec/create", http.StatusSeeOther)
}
